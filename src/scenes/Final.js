...
import handleControlVideo from "../utils/handleControlVideo.js";
...
class FinalScene extends Phaser.Scene {
    ...
    create (data){
        ...
        if(data.score < 9){
            ...
            handleVideoScale(gameWidth*(2/3),gameWidth*(2/3)*(311/540),videoFrameY -10)
            ...
            btnRePlay.on('pointerdown', function(){
                ...
                console.log("handleControlVideo(REMOVE)")
                handleControlVideo("PAUSE")
